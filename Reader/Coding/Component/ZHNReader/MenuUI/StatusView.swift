...
class RMStatusView: BaseView {
    
    /// 电池
    private(set) var batteryView:BatteryView!
    ...
    func addTimer() {
        ...
        if timer == nil {
            ...
            timer = Timer.scheduledTimer(timeInterval: 15, target: self, selector: #selector(RMStatusView.didChangeTime), userInfo: nil, repeats: true)
