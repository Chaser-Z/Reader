...
class RMLeftView: BaseView,SegmentedControlDelegate,UITableViewDelegate,UITableViewDataSource {
    
    /// topView
    private(set) var topView:SegmentedControl!
    ...
    func segmentedControl(segmentedControl: SegmentedControl, clickButton button: UIButton, index: NSInteger) {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var cell = tableView.dequeueReusableCell(withIdentifier: "RMLeftViewCell")
        
        if cell == nil {
            
            cell = UITableViewCell(style: .default, reuseIdentifier: "RMLeftViewCell")
