...
@objc protocol SegmentedControlDelegate:NSObjectProtocol {
    
    /// 点击按钮
    @objc optional func segmentedControl(segmentedControl:SegmentedControl, clickButton button:UIButton, index:NSInteger)
}
...
class SegmentedControl: UIView {
    ...
    init(_ delegate:SegmentedControlDelegate? = nil) {
    ...
    private func addSubviews() {
        ...
        for i in 0..<count {
            ...
            button.addTarget(self, action: #selector(SegmentedControl.clickButton(button:)), for: .touchDown)
