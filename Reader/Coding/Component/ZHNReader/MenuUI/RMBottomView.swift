...
class RMBottomView: BaseView,ASValueTrackingSliderDelegate {
    ...
    override func addSubviews() {
        ...
        for i in 0 ..< funcIcons.count {
            ...
            button.tag = i
            button.addTarget(self, action: #selector(RMBottomView.clickButton(_:)), for: UIControlEvents.touchUpInside)
            addSubview(button)
        }
        ...
        previousChapter.addTarget(self, action: #selector(RMBottomView.clickPreviousChapter), for: .touchUpInside)
        ...
        nextChapter.addTarget(self, action: #selector(RMBottomView.clickNextChapter), for: .touchUpInside)
