...
private var HJBatteryLevelViewScale = HJBatteryLevelViewW / BatterySize.width
...
class BatteryView: UIImageView {
    ...
    override func layoutSubviews() {
        ...
        let spaceW:CGFloat = 1 * (frame.width / BatterySize.width) * HJBatteryLevelViewScale
        let spaceH:CGFloat = 1 * (frame.height / BatterySize.height) * HJBatteryLevelViewScale
